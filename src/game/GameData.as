package game
{
	public class GameData
	{
		...
		private var _imagesOpenedOnStart:Array;		// contains arrays with 2 values - row and column of selected image
		private var _verticalConditions:Array;		// contains arrays with 3 values.
													// first number is 0 or 1; 0 means posititve condition.
													// next 2 numbers point to image numbers.
		private var _horizontalConditions:Array;	// contains arrays with 5 itema.
		...
		public function GameData(solution:Array, itemsOpenedOnStart:Array, verticalConditions:Array, horizontalConditions:Array)
		{
			_matrix = solution;
			_imagesOpenedOnStart = itemsOpenedOnStart;
			_verticalConditions = verticalConditions;
			_horizontalConditions = horizontalConditions;
...
//			_horizontalConditions.push([0, 2, 54, -1, 24]);
		...
		public function getItemsOpenedOnStart():Array
		{
			return _imagesOpenedOnStart;
		}
		...
		public function getVerticalConditions():Array
		{
			return _verticalConditions;
		}
		
		public function getHorizontalCondition():Array
		{
			return _horizontalConditions;
		}
	}
}